...
export default function HeroSection() {
    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                <div className="w-2.5 h-2.5 rounded-full animate-pulse bg-[rgb(0,255,200)]"></div>
            ...
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Our platform helps you build and deliver faster — so you can focus on what matters.
            </motion.p>
