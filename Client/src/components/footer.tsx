            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    <a href="https://prebuiltui.com?utm_source=agentix">
                        <img className="h-9 w-auto" src="\src\assets\logo.svg" width={138} height={36} alt="logo" />
                    </a>
                    <p className="text-sm/7 mt-6">Thumblify is a free and open-source Thhumbnail generator.</p>
                </div>
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        <h2 className="font-semibold mb-5 text-white">Company</h2>
                        <a className="hover:text-slate-500 transition" href="#">Home</a>
                        <a className="hover:text-slate-500 transition" href="#">Support</a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        ...
                        <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-slate-900">
                            ...
                            <button className="bg-indigo-600 px-4 py-2 text-white rounded">Connect</button>
                        </div>
                    </div>
                </div>
            </div>
            <p className="py-4 text-center border-t mt-6 border-slate-700">
                Copyright 2026 © <a href="https://prebuiltui.com?utm_source=agentix">Thumblify</a> All Right Reserved.
            </p>
        </motion.footer>
    );
};